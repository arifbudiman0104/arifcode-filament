<nav class="p-4 dark:bg-gray-800 dark:text-gray-100">
    <div class="container flex justify-between h-16 mx-auto">
        <div class="flex">
            ...
            <ul class="items-stretch hidden space-x-3 lg:flex">
                <li class="flex">
                    <a rel="noopener noreferrer" href="/" class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent
                    {{-- dark:text-violet-400 dark:border-violet-400 --}}
                    ">Home</a>
                </li>
                <li class="flex">
                    <a rel="noopener noreferrer" href="/categories"
                        class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent ">Category</a>
                </li>
                <li class="flex">
                    <a rel="noopener noreferrer" href="/posts"
                        class="flex items-center px-4 -mb-1 border-b-2 dark:border-transparent">Posts</a>
                </li>
                <li class="flex">
        ...
        <div class="items-center flex-shrink-0 hidden lg:flex">
            <a href="/admin">
                <button type="button"
                    class="px-8 py-3 font-semibold rounded-full dark:bg-gray-100 dark:text-gray-800">Admin</button>
            </a>
        </div>
