...
@section('container')
{{-- <h1 class="text-white">Halaman About</h1> --}}
<div class="p-6  sm:p-12 dark:bg-gray-900 dark:text-gray-100">
    <div class="flex flex-col h-full space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
        ...
        <div class="flex flex-col h-full">
            <h4 class="text-lg font-semibold text-center md:text-left">Arif Budiman Arrosyid</h4>
            <p class="dark:text-gray-400">I am a Software Engineer who is studying Software Engineering at the
                University of Muhammadiyah Yogyakarta.</p>
                <br>
            <p class="dark:text-gray-400">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptate, ipsa sit
                ducimus autem eaque illo ab, exercitationem nostrum, nihil doloremque quidem vitae libero? Eligendi ipsa
                voluptates nesciunt, rerum soluta, reprehenderit tempora culpa aperiam accusantium illum dolorum.
                Voluptates ipsam perspiciatis blanditiis ducimus tempora eum magni labore natus rem? Dolorem eum officia
                quibusdam facere modi delectus cumque eveniet mollitia repellat commodi veniam temporibus a optio earum
                tempora ad fuga porro atque aliquid, aperiam, voluptatum sunt ducimus illum exercitationem. Expedita,
                alias! Beatae itaque odit laudantium cupiditate optio! Inventore deleniti vel totam, magni, fugit hic
                doloribus quaerat veritatis ut tempora, quae exercitationem! Debitis, officia.</p>
        </div>
    </div>
    <div class="flex justify-center pt-4 space-x-4 align-center">
        <a rel="noopener noreferrer" href="https://github.com/arifbudimanarrosyid" aria-label="GitHub"
